...
if (legacyPresent.length) errors.push(`legacy_sections_present=${legacyPresent.join(',')}`);
...
console.log(`Homepage web-read validation OK: ${requiredIds.length} sections, ${zoneCards} zone cards, ${permissionRows} permission rows`);
