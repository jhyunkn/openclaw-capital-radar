...
const SECTION_ALIASES = {
  macro: [CANONICAL_SECTION_IDS.macro, 'macro-unified-section', 'brief'],
...
function hasFourSectionSurface(html) {
  ...
  const preShipCompressed = hasSection(html, 'macro') && hasSection(html, 'chart') && hasSection(html, 'holdings') && hasSection(html, 'opportunity');
