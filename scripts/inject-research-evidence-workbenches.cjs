...
const css = `<style>.research-evidence{padding-top:28px}.research-evidence .section-title{display:flex;justify-content:space-between;gap:18px;align-items:flex-end}.evidence-summary{display:grid;grid-template-columns:2fr 1fr 1fr;gap:0;border-top:1px solid var(--rule);border-left:1px solid var(--rule);margin-top:16px}.evidence-summary article,.evidence-grid article,.evidence-subgrid section,.source-table{border-right:1px solid var(--rule);border-bottom:1px solid var(--rule);padding:16px;background:rgba(251,250,246,.14)}.research-evidence span{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.06em;font-weight:500;margin-bottom:9px}.research-evidence b{display:block;font-size:22px;line-height:1.05;letter-spacing:-.035em}.research-evidence p,.research-evidence li,.research-evidence dd,.research-evidence td{font-size:13px;line-height:1.42;color:rgba(36,35,31,.82)}.evidence-grid{display:grid;grid-template-columns:1fr 1fr;gap:0;border-top:1px solid var(--rule);border-left:1px solid var(--rule);margin-top:18px}.evidence-grid dl{margin:0;display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.evidence-grid dt{font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--muted)}.evidence-grid dd{margin:3px 0 0;font-variant-numeric:tabular-nums}.evidence-subgrid{display:grid;grid-template-columns:1fr 1fr;gap:0;border-top:1px solid var(--rule);border-left:1px solid var(--rule);margin-top:18px}.evidence-subgrid section>div{display:grid;gap:8px}.evidence-subgrid article{border:1px solid var(--rule);padding:12px;background:rgba(251,250,246,.16)}.evidence-subgrid small{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.06em;margin-top:8px}.source-table{border-left:1px solid var(--rule);border-top:1px solid var(--rule);margin-top:18px;overflow:auto}.source-table table{width:100%;border-collapse:collapse;font-variant-numeric:tabular-nums}.source-table th{font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);text-align:left;padding:8px;border-bottom:1px solid var(--rule)}.source-table td{padding:8px;border-bottom:1px solid var(--rule);vertical-align:top}@media(max-width:1000px){.evidence-summary,.evidence-grid,.evidence-subgrid{grid-template-columns:1fr}.research-evidence .section-title{display:block}.research-evidence .section-title .button{margin-top:12px}}</style>`;
let count = 0;
