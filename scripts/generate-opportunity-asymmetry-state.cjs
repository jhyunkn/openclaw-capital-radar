...
const NAME_OVERRIDES = { NXT: 'Nextpower' };
function companyName(ticker, fallback) {
  const t = String(ticker || '').toUpperCase();
  return NAME_OVERRIDES[t] || fallback || t;
}
