...
Generated: 2026-06-30T19:14:49.628Z
...
- Current price: 334.07
- Price read: relative strength / momentum; avoid chasing until base or catalyst confirmed

## Why Interesting

Infrastructure-side exposure to AI/data-center buildout: power, cooling, and uptime constraints rather than model/platform winners.

## Why Now

- VRT positive 8.83% while broad tape is weak.
...
- capital-radar-live-state: internal candidate thesis and current quote context (strong-context)
- yahoo-chart-public: price/relative-strength/dislocation signal only (weak-context-only)
- market-stress-brief: local stress/anomaly classification (internal-signal)
- sec-company-submissions: required next primary-source filing check before promotion (primary-evidence; required_not_yet_attached)
- company-investor-relations: required thesis/catalyst source before promotion (strong-context; required_not_yet_attached)

## Confirm Before Promotion

- Backlog/order growth supports the AI infrastructure thesis
- Margins remain resilient as capacity scales
- Entry price compensates for crowded theme risk

## Invalidation / Risk Questions

- Risk to invalidate/check: Theme crowding
- Risk to invalidate/check: Execution and margin pressure
- Risk to invalidate/check: Industrial cyclicality if capex slows
