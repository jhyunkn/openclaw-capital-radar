...
.kostolany-egg .egg-read article,.kostolany-egg .prob-strip article,.kostolany-egg .egg-axis article{background:rgba(251,250,246,.42)!important;border:1px solid rgba(44,42,37,.08)!important;border-radius:16px!important}
