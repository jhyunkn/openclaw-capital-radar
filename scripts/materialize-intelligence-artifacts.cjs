...
copyOutput('institutional-evidence-map.json', evidenceMap => {
  ...
  if (!ids.has('ev_014')) evidenceMap.evidence.push({
    ...
    citation: 'Cboe VIX page showed VIX spot 16.70 as of May 22, 2026 with delayed market data.',
    publish_date: '2026-05-22',
    retrieved_at: generatedAt,
    reliability_score: 0.9,
    relevance_score: 0.86,
    freshness_score: 0.92,
    extracted_insight: 'VIX near 16.70 supports a moderate-volatility backdrop, but it does not by itself authorize new risk without holdings-level evidence.',
