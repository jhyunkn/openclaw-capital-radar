...
- Current price: 113.77
- Price read: neutral price context; compare against thesis and valuation evidence

## Why Interesting

More experimental energy-infrastructure idea: not just AI power demand, but grid-edge hardware and utility-scale solar deployment efficiency.

## Why Now

- NXT positive 3.67% while broad tape is weak.
...
- Bookings/backlog support growth
- Margins are not peaking cyclically
- Policy/tariff risks are understood

## Invalidation / Risk Questions

- Risk to invalidate/check: Solar cyclicality
- Risk to invalidate/check: Policy and tariff risk
- Risk to invalidate/check: Smaller-cap volatility
