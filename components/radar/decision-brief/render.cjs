...
function renderDecisionBriefSection(state) {
  return `<section id="decision-brief-section" class="panel decision-brief-panel command-brief macro-reading-panel">
    <div class="section-head"><div><p class="eyebrow">Macro Reading</p><h2>Regime, confirmation, and permission</h2></div><a class="button" href="outputs/market-decision-brief-state.json">Open brief state</a></div>
