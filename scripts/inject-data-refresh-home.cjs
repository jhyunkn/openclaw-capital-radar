...
.data-refresh-panel{border-top:1px solid var(--rule);background:rgba(251,250,246,.18)}
...
.decision-summary-grid{display:grid;grid-template-columns:1.25fr .8fr .95fr;border-left:1px solid var(--rule);border-top:1px solid var(--rule);margin-top:24px}.decision-summary-grid article{border-right:1px solid var(--rule);border-bottom:1px solid var(--rule);padding:18px 18px 20px;background:rgba(251,250,246,.22)}.decision-summary-grid span,.coverage-strip span,.evidence-blockers span{display:block;color:var(--muted);font-size:10px;text-transform:uppercase;letter-spacing:.10em}.decision-summary-grid strong{display:block;margin-top:12px;font-size:clamp(24px,2.3vw,38px);line-height:1;letter-spacing:-.05em;font-weight:500}.decision-summary-grid p{margin-top:12px;color:rgba(36,35,31,.66);font-size:13px;line-height:1.45;max-width:520px}
.coverage-strip{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));border-top:1px solid var(--rule);border-left:1px solid var(--rule);margin-top:18px}.coverage-strip article{border-right:1px solid var(--rule);border-bottom:1px solid var(--rule);padding:14px;background:rgba(251,250,246,.16)}.coverage-strip b{display:block;font-size:28px;line-height:1;margin-top:10px;font-weight:500;letter-spacing:-.04em}
.source-ledger-table-wrap{margin-top:18px;border:1px solid var(--rule);overflow:auto;background:rgba(251,250,246,.18)}.source-ledger-table{width:100%;border-collapse:collapse;min-width:980px}.source-ledger-table th,.source-ledger-table td{padding:13px 14px;border-bottom:1px solid var(--rule);text-align:left;vertical-align:top;font-size:12px;line-height:1.35}.source-ledger-table thead th{color:var(--muted);font-size:10px;text-transform:uppercase;letter-spacing:.10em;font-weight:500;background:rgba(251,250,246,.28)}.source-ledger-table tbody th{font-size:13px;font-weight:500}.source-ledger-table td{color:rgba(36,35,31,.70)}.source-ledger-table td strong{font-size:10px;letter-spacing:.08em;font-weight:600}.source-ledger-table td span{color:var(--muted);font-size:11px}.source-row.fresh td strong{color:var(--green)}.source-row.partial td strong{color:var(--warn)}.source-row.stale td strong{color:var(--red)}
.evidence-blockers{margin-top:18px;border:1px solid var(--rule);background:rgba(251,250,246,.16);padding:16px}.evidence-blockers ul{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px 28px;margin:10px 0 0;padding-left:18px;color:rgba(36,35,31,.74);font-size:13px;line-height:1.45}
