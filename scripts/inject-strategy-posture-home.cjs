...
if (html.includes('id="strategy-section"')) {
  console.log('strategy posture already present; skipping injection');
  process.exit(0);
}
...
console.log(`injected strategy posture: ${strategy.overall_posture}`);
