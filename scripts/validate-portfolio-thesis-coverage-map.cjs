...
for (const h of data.holdings) {
  ...
  ok(['underwritten','partial','thin'].includes(h.coverageState), `${h.ticker} bad coverage state`);
...
console.log(`thesis coverage validated: ${data.holdings.length} holdings, avg ${data.summary.averageCoverageScore}%`);
